...
CurrentBlockchainStatus::load_current_emission_amount()
{
    ...
    string last_saved_emmision = exohoodeg::read(emmision_saved_file);
...
bf::path CurrentBlockchainStatus::blockchain_path {"/home/mwo/.exohood/lmdb"};
...
exohoodeg::MicroCore*  CurrentBlockchainStatus::mcore {nullptr};
}
