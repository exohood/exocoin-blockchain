...
main(int ac, const char* av[])
{
    ...
    CROW_ROUTE(app, "/")
    ([&]() {
        return myetn::htmlresponse(exoblocks.index2());
    });

    CROW_ROUTE(app, "/page/<uint>")
    ([&](size_t page_no) {
        return myetn::htmlresponse(exoblocks.index2(page_no));
    });

    CROW_ROUTE(app, "/block/<uint>")
    ([&](size_t block_height) {
        return myetn::htmlresponse(exoblocks.show_block(block_height));
    });

    CROW_ROUTE(app, "/block/<uint>/page/<uint>")
    ([&](size_t block_height, size_t page_no) {
        return myetn::htmlresponse(exoblocks.show_block(block_height, page_no));
    });
...
//        });
    ...
    ([&](const crow::request& req, string tx_hash,
        string etn_address, string viewkey)
     {
        ...
        return myetn::htmlresponse(exoblocks.show_my_outputs(
                                         remove_bad_chars(tx_hash),
        ...
        ([&](const crow::request& req) -> myetn::htmlresponse 
         {
            ...
            return myetn::htmlresponse(exoblocks.show_prove(tx_hash,
                                        etn_address,
                                        tx_prv_key,
                                        raw_tx_data,
                                        domain));
    ...
    ([&](const crow::request& req, string tx_hash,
         string etn_address, string tx_prv_key) 
     {
        ...
        return myetn::htmlresponse(exoblocks.show_prove(
                                    remove_bad_chars(tx_hash),
                                    remove_bad_chars(etn_address),
    ...
    if (enable_pusher)
    {
        ...
        ([&]() {
            return myetn::htmlresponse(exoblocks.show_rawtx());
        });
    ...
    if (enable_key_image_checker)
    {
        ...
        ([&]() {
            return myetn::htmlresponse(exoblocks.show_rawkeyimgs());
        });
    ...
    if (enable_output_key_checker)
    {
        ...
        ([&]() {
            return myetn::htmlresponse(exoblocks.show_rawoutputkeys());
        });
    ...
    ([&]() {
        return myetn::htmlresponse(exoblocks.mempool(true));
    });
    ...
    ([&](string address) -> myetn::htmlresponse
     {
         ...
         return myetn::htmlresponse(exoblocks.show_address_details(address_info));
     });
    ...
    ([&](string address, size_t page_no) -> myetn::htmlresponse
     {
        ...
        address = remove_bad_chars(address);
         ...
         return myetn::htmlresponse(exoblocks.show_address_details(address_info, nettype_addr, page_no));
     });
...
//    });
    ...
    if (enable_json_api)
    {
        ...
        ([&](string tx_hash) {
            ...
            myetn::jsonresponse r{exoblocks.json_transaction(remove_bad_chars(tx_hash))};
        ...
        ([&](string tx_hash) {
            ...
            myetn::jsonresponse r{exoblocks.json_rawtransaction(remove_bad_chars(tx_hash))};
        ...
        ([&](string tx_hash) {
            ...
            myetn::jsonresponse r{exoblocks.json_detailedtransaction(remove_bad_chars(tx_hash))};
        ...
        ([&](string block_no_or_hash) {
            ...
            myetn::jsonresponse r{exoblocks.json_block(remove_bad_chars(block_no_or_hash))};
        ...
        ([&](string block_no_or_hash) {
            ...
            myetn::jsonresponse r{exoblocks.json_rawblock(remove_bad_chars(block_no_or_hash))};
        ...
        ([&](const crow::request &req) {
            ...
            myetn::jsonresponse r{exoblocks.json_transactions(
        ...
        ([&](const crow::request &req) {
            ...
            myetn::jsonresponse r{exoblocks.json_mempool(
                    remove_bad_chars(page), remove_bad_chars(limit))};
        ...
        ([&](string search_value) {
            ...
            myetn::jsonresponse r{exoblocks.json_search(remove_bad_chars(search_value))};
        ...
        ([&]() {
            ...
            myetn::jsonresponse r{exoblocks.json_networkinfo()};
        ...
        ([&]() {
            ...
            myetn::jsonresponse r{exoblocks.json_emission()};
        ...
        ([&](const crow::request &req) {
            ...
            myetn::jsonresponse r{exoblocks.json_outputs(
                    remove_bad_chars(tx_hash),
        ...
        ([&](const crow::request &req) {
            ...
            myetn::jsonresponse r{exoblocks.json_outputsblocks(
        ...
        ([&]() {
            ...
            myetn::jsonresponse r{exoblocks.json_version()};
